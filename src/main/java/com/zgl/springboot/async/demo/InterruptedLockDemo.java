...
/**
 * @author zgl
 * @date 2020/1/28 下午9:16
 */
public class InterruptedLockDemo implements Runnable{
	 ...
	 * @param lock
	 */
	public InterruptedLockDemo(int lock) {
		this.lock = lock;
	}
	...
	public static void main(String[] args) throws InterruptedException {
		...
		InterruptedLockDemo r1 = new InterruptedLockDemo(1);
		InterruptedLockDemo r2 = new InterruptedLockDemo(2);
